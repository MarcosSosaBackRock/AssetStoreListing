...
namespace BackRock
{
    public class OrbitCamera : MonoBehaviour
    {
        ...
        public void SetCharacterView(CharacterAnimations character)
        {
            if (character.UpCloseChar)
                targetDistance = character.upCloseDistance;
            else
